...
Directed Acyclic Graphs (DAGs)
  ...
  At the heart of Airflow are Directed Acyclic Graphs (DAGs), which represent workflows as collections of tasks organized with dependencies and relationships. 
  DAGs ensure tasks are executed in a specific order without looping back, providing a clear and logical representation of complex workflows.
....

....
Tasks 

  Tasks are the smallest unit of work in Airflow. They are the individual units of work that make up a DAG. 
  These are typically implemented using Operators.
...
Operators  
  ...
  Operators are the classes that define the logic of a task. 
  They are the smallest unit of work in Airflow.
