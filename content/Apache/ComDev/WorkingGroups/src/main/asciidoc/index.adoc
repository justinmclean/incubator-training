...
* ComDev exists to help projects build their communities
...
your expertise, but having the working group emboldens people to do this
...
* Becoming a committer! Becoming a PMC member! Becoming a PMC chair!
* Attending events
* Being a RM
* Voted on a release
--
...
This presentation is part of the Apache Training project,
